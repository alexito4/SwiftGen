...
internal extension LocationPicker.LocationPickerViewController {
  ...
  internal enum TypedStoryboardSegue {
    ...
    case `public`(destination: SlackTextViewController.SLKTextViewController, segue: NotCurrentModule.SlideUpSegue)
    case unnamedSegue
    ...
    init(segue: StoryboardSegue) {
      ...
      case "public":
        guard let segue = segue as? NotCurrentModule.SlideUpSegue else {
          fatalError("Segue 'public' is not of the expected type NotCurrentModule.SlideUpSegue.")
        }
        guard let vc = segue.destination as? SlackTextViewController.SLKTextViewController else {
...
internal extension NotCurrentModule.PickerViewController {
  internal enum StoryboardSegue: String {
  ...
  internal enum TypedStoryboardSegue {
    ...
    case showNavCtrl(destination: UIKit.UINavigationController, segue: NotCurrentModule.CustomSegueClass)
    case unnamedSegue
    ...
    init(segue: StoryboardSegue) {
      ...
      case "Show-NavCtrl":
        guard let segue = segue as? NotCurrentModule.CustomSegueClass else {
          fatalError("Segue 'Show-NavCtrl' is not of the expected type NotCurrentModule.CustomSegueClass.")
        }
      ...
      case "":
        self = .unnamedSegue
      default:
        fatalError("Unrecognized segue '\(segue.identifier ?? "")' in NotCurrentModule.PickerViewController")
      }
    }
    // swiftlint:enable cyclomatic_complexity
  }
