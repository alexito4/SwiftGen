...
public extension NotCurrentModule.DetailsViewController {
  ...
  public enum TypedStoryboardSegue {
    ...
    init(segue: StoryboardSegue) {
      ...
      case "":
        self = .unnamedSegue
      default:
        fatalError("Unrecognized segue '\(segue.identifier?.rawValue ?? "")' in NotCurrentModule.DetailsViewController")
      }
    }
